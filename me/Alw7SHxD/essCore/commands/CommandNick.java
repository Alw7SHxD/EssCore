...
import me.Alw7SHxD.essCore.API.EssNickAPI;
...
public class CommandNick implements CommandExecutor, messages {
    ...
    public boolean onCommand(CommandSender commandSender, Command command, String s, String[] strings) {
        ...
        if (strings.length == 1) {
            ...
            EssNickAPI nickAPI = new EssNickAPI((Player) commandSender);
            ...
            EssNickAPI nickAPI = new EssNickAPI(target);
    ...
    private boolean checkOff(EssNickAPI nickAPI, CommandSender commandSender, Player player, String s) {
